PZRolePlayingRolesVanilla = PZRolePlayingRolesVanilla or {}

print("[PZRolePlaying] vanilla roles charge - " .. tostring(20) .. " roles")

local Roles = PZRolePlayingRolesVanilla
